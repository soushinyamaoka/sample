...
public class DBAdapter2 extends AppCompatActivity {
    ...
    public ArrayList<String> readDB() throws Exception {
        ...
        try {
            ...
            adapter = new SimpleCursorAdapter(this,R.layout.list,c,cols,new int[] {R.id.text1},CursorAdapter.FLAG_REGISTER_CONTENT_OBSERVER);
